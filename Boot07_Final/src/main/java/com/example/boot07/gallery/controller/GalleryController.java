...
public class GalleryController {
	...
	// detail page
	@RequestMapping(value="/gallery/detail", method=RequestMethod.POST)
	public ModelAndView detail(ModelAndView mView, int num) {
		// Gallery detail 페이지에 필요한 data를 num으로 가져와 ModelAndView 에 저장
	...
	public String upload(GalleryDto dto, HttpServletRequest request) {
		// form에서 dto로 데이터 받아옴
		// dto : caption, MultipartFile image 를 가지고 있음
		// request : imagePath 만드는 데 사용, session 영역의 id를 가져오는 데에 사용
